...
private:
	...
	void initialize(); // Called in the constructor function to initialize 
					   // the various data structures used in the project

    /////////////////////////////////////////////////////////////////////
    // Functions regarding the Free List
    /////////////////////////////////////////////////////////////////////

    int 	freeListAvailability(); // Calculates the number of physical 
									// registers present in the free list
									// to rename the destination registers
									// in the bundle
    bool 	isFreeListEmpty(); // Checks whether the free list is empty
    bool 	isFreeListFull(); // Checks whether the free list is full
    void 	pushOntoFreeList(int phyDest); // Pushes a physical register
										   // onto the free list post
										   // retirement
	void 	restoreFreeList(); // Roll the head pointer to tail pointer

    /////////////////////////////////////////////////////////////////////
    // Functions regarding the Active List
    /////////////////////////////////////////////////////////////////////

    void 	initializeActiveList(); // Initialization of active list
    int 	activeListAvailability(); // Calculates slots available in the
									  // active list
    bool 	isActiveListEmpty(); // Checks whether the active list is empty
    bool 	isActiveListFull(); // Checks whether the active list is full
    int 	obtainActiveListIndex(); // Gets the index of the active list
									 // into which the instruction is
									 // being dispatched
    void	retireFromActiveList(); // Increment active list head pointer
								    // upon instruction retirement
    void 	flushActiveList(); // Flush active list in case of a full squash
